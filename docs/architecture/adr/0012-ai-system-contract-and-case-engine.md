...
4. Case state is a synchronous projection of ledger events (`case/<id>` streams) and can be rebuilt from the ledger. Approvals and actions are append-only tables.
